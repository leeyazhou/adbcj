...
public class IoUtilsTest {
  ...
  public void someNullMutlipleByte() throws IOException {
    ...
    Assert.assertEquals(IOUtil.nullMask(new Object[] {null, 1, 1, 1, 1, 1, 1, 1, null, 1, 1, 1, 1, 1, 1, 1})[0],
        (byte) 1);
    Assert.assertEquals(IOUtil.nullMask(new Object[] {null, 1, 1, 1, 1, 1, 1, 1, null, 1, 1, 1, 1, 1, 1, 1})[1],
        (byte) 1);


    byte mostSignificatBitSet = (byte) 0x80;
    byte mostAndLeastBitSet = (byte) (mostSignificatBitSet | 0x01);
    Assert.assertEquals(IOUtil.nullMask(new Object[] {null, 1, 1, 1, 1, 1, 1, null, null, 1, 1, 1, 1, 1, 1, null})[0],
        mostAndLeastBitSet);
    Assert.assertEquals(IOUtil.nullMask(new Object[] {null, 1, 1, 1, 1, 1, 1, null, null, 1, 1, 1, 1, 1, 1, null})[1],
        mostAndLeastBitSet);
  }
