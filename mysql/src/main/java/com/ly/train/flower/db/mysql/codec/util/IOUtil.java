...
public final class IOUtil {
  ...
  public static void writeLengthCodedString(OutputStream out, String stringToWrite, Charset charset)
      throws IOException {
  ...
  public static String readNullTerminatedString(BoundedInputStream in, Charset charset) throws IOException {
    ...
    for (int c = in.read(); c > 0; c = in.read()) {
      out.write(c);
      // fixbug: lost the last char issue. The remaining decision should be placed
      // here
  ...
  /**
   * Creates a null value bit mask, according to
