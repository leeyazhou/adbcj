...
abstract class FinishPrepareStatement extends DecoderState {
  ...
  FinishPrepareStatement(MySqlConnection connection, PreparedStatementToBuild statement,
  ...
  public static DecoderState create(MySqlConnection connection, PreparedStatementToBuild statement,
  ...
  private static class ReadParameters extends FinishPrepareStatement {
    ...
    public ReadParameters(MySqlConnection connection, int parametersToParse, PreparedStatementToBuild statement,
        DbCallback<MySqlPreparedStatement> callback) {
    ...
    @Override
    public ResultAndState parse(int length, int packetNumber, BoundedInputStream in, Channel channel)
        throws IOException {
      ...
      types.add(newType);
      PreparedStatementToBuild newStatement =
          new PreparedStatementToBuild(length, packetNumber, statement.getPreparedStatement(), types);
  ...
  private static class EofAndColumns extends FinishPrepareStatement {
    ...
    public EofAndColumns(MySqlConnection connection, PreparedStatementToBuild statement,
        DbCallback<MySqlPreparedStatement> toComplete) {
  ...
  private static class ReadColumns extends FinishPrepareStatement {
    ...
    public ReadColumns(MySqlConnection connection, int restOfColumns, PreparedStatementToBuild statement,
        DbCallback<MySqlPreparedStatement> callback) {
      super(connection, statement, callback);
  ...
  private static class EofStatement extends FinishPrepareStatement {
    ...
    public EofStatement(MySqlConnection connection, PreparedStatementToBuild statement,
        DbCallback<MySqlPreparedStatement> toComplete) {
      super(connection, statement, toComplete);
    }
