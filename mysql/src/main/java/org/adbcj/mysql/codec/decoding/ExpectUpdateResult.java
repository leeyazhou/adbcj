...
public class ExpectUpdateResult<T> extends ExpectOK<T> {
  ...
  public ExpectUpdateResult(MySqlConnection connection, DbCallback<T> callback, StackTraceElement[] entry) {
  ...
  static <TFutureType> ResultAndState handleUpdateResult(MySqlConnection connection, OkResponse.RegularOK regularOK,
