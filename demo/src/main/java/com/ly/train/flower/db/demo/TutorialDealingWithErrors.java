...
public class TutorialDealingWithErrors {
  ...
  /**
   * If you just run this, the error stack trace will not reference this method at
   * all.
   * <p>
   * When you use '-Dorg.asyncdb.debug=true' as JVM start up parameter, this
   * method will show up in the cause. Alternative: Add property
   * "org.asyncdb.debug"="true" in the properties hashmap when connecting
   * <p>
   * Note: This feature has a high overhead. It is indent for to be used during
