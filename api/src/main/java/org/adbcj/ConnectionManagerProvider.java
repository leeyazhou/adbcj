...
/**
 * The connection manager provider is the entry point for ADBCJ. It looks up the
...
public final class ConnectionManagerProvider {
   ...
   *        adbcj:your-database-type://host:port/database. Example
   *        adbcj:mysql:localhost:3306/database
