...
public final class StandardProperties {
  ...
  /**
   * ADBCJ allows to have multiple async operations open running. This parameter
  ...
  /**
   * ADBCJ allows you to capture the stack trace of the location which issues a
   ...
   *
   * If not set, the JVM global property 'org.adbcj.debug' set to true will force
