...
public class CloseConnectionsTest extends AbstractWithConnectionManagerTest {
  ...
  public void foreClosingManagerClosesConnections(String url, String user, String password) throws Exception {
    ...
    Assert.assertTrue(runningQuery2.isDone() || !runningQuery2.isDone(), "Why is instance done?: ");
  }
  ...
  public void forceCloseConnections() throws Exception {
    ...
    final CompletableFuture<ResultSet> rs2 = connection
        .executeQuery("SELECT int_val, str_val " + "FROM simple_values where str_val LIKE 'Not-In-Database-Value'");
    final CompletableFuture<ResultSet> rs3 = connection
        .executeQuery("SELECT int_val, str_val " + "FROM simple_values where str_val LIKE 'Not-In-Database-Value'");
  ...
  private void checkClosed(final Connection c1, Future<ResultSet> runningQuery, Future<ResultSet> runningQuery2,
      Connection c2) {
