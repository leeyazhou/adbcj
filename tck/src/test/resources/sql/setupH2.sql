...
CREATE ALIAS SLEEP FOR "com.ly.train.flower.db.tck.h2.SleepFunction.sleep";

CREATE USER IF NOT EXISTS "ASYNCDB-OTHER-USER" PASSWORD 'asyncdb-other-user';
ALTER USER "ASYNCDB-OTHER-USER" ADMIN TRUE;
