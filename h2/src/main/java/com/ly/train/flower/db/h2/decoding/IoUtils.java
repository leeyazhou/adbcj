...
public final class IoUtils {
  ...
  public static ResultOrWait<Boolean> tryReadNextBoolean(DataInputStream stream, ResultOrWait previousResult)
      throws IOException {
  ...
  public static ResultOrWait<Integer> tryReadNextInt(DataInputStream stream, ResultOrWait previousResult)
      throws IOException {
    if (!previousResult.couldReadResult) {
      return previousResult;
    }
  ...
  public static ResultOrWait<Long> tryReadNextLong(DataInputStream stream, ResultOrWait previousResult)
      throws IOException {
    if (!previousResult.couldReadResult) {
      return previousResult;
    }
  ...
  public static ResultOrWait<Double> tryReadNextDouble(DataInputStream stream, ResultOrWait previousResult)
      throws IOException {
    if (!previousResult.couldReadResult) {
      return previousResult;
    }
  ...
  public static ResultOrWait<String> tryReadNextString(DataInputStream stream, ResultOrWait previousResult)
      throws IOException {
    if (!previousResult.couldReadResult) {
      return previousResult;
    }
  ...
  public static ResultOrWait<byte[]> tryReadNextBytes(DataInputStream stream, ResultOrWait<?> previousResult)
      throws IOException {
    if (!previousResult.couldReadResult) {
      return ResultOrWait.WaitLonger;
    }
